...
class EffectiveMeshSizeGlobalAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self,parameters,context,feedback):
        ...
        if include_cbc:
            res_feat[self.CBC_NET_PRODUCT] = cbc_net_product
            res_feat[self.CBC_MESH_SIZE] = cbc_net_product / report_area
        sink.addFeature(res_feat)
        return {self.OUTPUT: dest_id, self.OUTPUT_GLOBAL_MEFF : res_feat[self.MESH_SIZE]}


class EffectiveMeshSizeGlobalAlgorithmOld(QgsProcessingAlgorithm):

    ALG_NAME = "effectiveMeshSizeGlobalOld"
    ...
    def createInstance(self):
        return EffectiveMeshSizeGlobalAlgorithmOld()
