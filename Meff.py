...
class Meff:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Mesh Effective Size')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'Meff')
        self.toolbar.setObjectName(u'Meff')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Meff', message)
