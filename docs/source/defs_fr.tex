...
\fancyfoot[C]{\color{lightgray} \textit{FragScape v2.0 - Notice d'utilisation}}
...
\vspace{0.3cm}
\begin{tabular}{cccc}
\includegraphics[scale=0.07]{pictures/logoINRAE.png}\hspace{1cm}
&
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[scale=0.3]{pictures/logoINRAE.png}\hspace{1cm}
&
...
Mathieu Chailloux (INRAE / UMR TETIS) - \textit{mathieu.chailloux@inrae.fr}\\
Jennifer Amsallem (INRAE / UMR TETIS) - \textit{jennifer.amsallem@inrae.fr}\\
